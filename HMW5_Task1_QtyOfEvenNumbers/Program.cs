...
int min = 100;     // Нижняя граница диапазона, из которого берем числа для заполнения массива
int max = 999;     // Верхняя граница диапазона, из которого берем числа для заполнения массива
int length = 20;   // Длина массива (количество элементов в нем)
